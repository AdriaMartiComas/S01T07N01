...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("El treballador: " + treballador1.getNom() + " " + treballador1.getCognom()
				+ ", te un sou mensual de:" + sou1);
		System.out.println("El treballador: " + treballador2.getNom() + " " + treballador2.getCognom()
				+ ", te un sou mensual de:" + sou2);
